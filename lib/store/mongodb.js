...
function MongoStore (options) {
  ...
  var exec = (function (self) {
    ...
    client = self.options.client || new Db(self.options.db || 'test', new Server(self.options.host || '127.0.0.1', self.options.port || 27017, self.options.serverOptions || {}), self.options.dbOptions || {});
